              ...
              >
                <Avatar
                  ...
                  :src="
                    !!updateForm.logoSrc
                      ? updateForm.logoSrc
                      : generateAvatar(props.workspace.name, 5)
                  "
                >
                  <template #icon>
                    <PlusOutlined />
      ...
      <Collapse v-model:activeKey="activeKey" ghost>
        <CollapsePanel key="leave" header="Leave workspace">
          <div class="text-gray-500">
            Please proceed with caution. Leaving this workspace will result in
            the loss of access to all associated data, projects, and pages. If
            you wish to rejoin in the future, you will need to be re-invited by
            an existing member. Ensure you are certain of this decision before
            proceeding.
          </div>
          <Button
            danger
        ...
        <CollapsePanel
          ...
          :collapsible="isAdmin ? 'header' : 'disabled'"
        >
          <div class="text-gray-500">
            Please proceed with extreme caution. Deleting this workspace will
            permanently erase all associated data, boards, and pages. Members
            will lose access immediately, and the workspace cannot be recovered.
